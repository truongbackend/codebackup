            ...
            <div class="card-body">
                <div class="table-responsive text-nowrap table-scroll table-px">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(doanhthu_theokenhs, index) in doanhthu_theokenh" :key="index">
                                <td>{{ doanhthu_theokenhs.ten }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.soluong_kehoach) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.doanhso_kehoach) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.soluong_namnay) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.doanhso_namnay) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.tile_datduoc) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.tientang_kiemnghiem) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.soluong_cungky) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.doanhso_cungky) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.tt_cungky) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.soluong_namtruoc) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.doanhso_namtruoc) }}</td>
                                <td>{{ formatNumber(doanhthu_theokenhs.tang_truong) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card mt-4">
            <div class="card-header justify-content-between text-center">
                <h5 class="card-title m-0">Doanh số theo nhóm khách hàng</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive text-nowrap table-scroll table-px">
                    <table class="table table-bordered">
...
<div class="row">
    <div class="col-md-6">
        <div class="card mt-4">
            <div class="card-header justify-content-between text-center">
                <h5 class="card-title m-0">Doanh số theo nhân viên</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive text-nowrap table-scroll table-px">
                    <table class="table table-bordered">
