<template>
    ...
    <div class="card">
      <div class="card-header justify-content-between">
        <h5 class="card-title m-0">Babyshop</h5>
      </div>
      <div class="card-body">
  ...
  export default defineComponent({
    setup() {
      ...
      const getOrder = () => {
        axios
          .get(
            `https://babyshop24.vn/wp-json/wc/v3/orders?consumer_key=ck_1771d3fd44a1c5c0ad2c0e0224f4f85d1d57b87e&consumer_secret=cs_12f295159af464c1e151f1a5e471d2953842afc9`
          )
          .then((response) => {
      ...
      axios
        .get(
          `https://babyshop24.vn/wp-json/wc/v3/orders/${orderId}?consumer_key=ck_1771d3fd44a1c5c0ad2c0e0224f4f85d1d57b87e&consumer_secret=cs_12f295159af464c1e151f1a5e471d2953842afc9`
        )
        .then((response) => {
