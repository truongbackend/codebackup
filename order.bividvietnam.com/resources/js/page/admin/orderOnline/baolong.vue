<template>
    ...
    <div class="card">
      <div class="card-header justify-content-between">
        <h5 class="card-title m-0">Dược Bảo Long</h5>
      </div>
      <div class="card-body">
  ...
  export default defineComponent({
    setup() {
      ...
      const getOrder = () => {
        axios
          .get(
            `https://duocbaolong.vn/wp-json/wc/v3/orders?consumer_key=ck_98ab1f13edba1a77fd163b748ace9e7096c9db79&consumer_secret=cs_eadd8975295bc7f0812e3b7e598ae2c43502daf6`
          )
          .then((response) => {
            orderBaoLong.value = response.data;
            console.log(orderBaoLong.value);
          })
          .catch((error) => {
      ...
      axios
        .get(
          `https://duocbaolong.vn/wp-json/wc/v3/orders/${orderId}?consumer_key=ck_98ab1f13edba1a77fd163b748ace9e7096c9db79&consumer_secret=cs_eadd8975295bc7f0812e3b7e598ae2c43502daf6`
        )
        .then((response) => {
